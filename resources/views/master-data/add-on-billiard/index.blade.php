                ...
                <div class="card-header rounded-t-20 pt-1 pl-2 pb-2 pr-2">
                    <div class="row">
                        ...
                        <div class="col-6 text-right px-4">
                            ...
                            @can('add-on-create')
                            <button class="btn btn-sm btn-success btn-open-modal p-2" data-toggle="modal" data-target="#tambah-add-on-billiard">
                                Tambah
                            </button>
                            @endcan
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('add-on-edit')
                                    <a class="btn btn-warning p-2" href="{{ route('add-on-billiard.edit', $add_on->id) }}">
                                        <i class="fa fa-edit"></i> 
                                        Edit
                                    </a>
                                    @endcan
                                    @can('add-on-delete')
                                    <a href="#" class="btn btn-danger p-2 f-12" onclick="modalDelete('Add On Billiard', '{{ $add_on->title }}', '/add-on-billiard/' + {{ $add_on->id }}, '/add-on-billiard/')">
...
@include('master-data.add-on-billiard.create')
@endsection

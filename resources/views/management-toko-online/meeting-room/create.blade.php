<div class="modal modal-fullscreen" id="tambah-meeting-room" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="forms-sample" action="{{ route('meeting-room.store') }}" enctype="multipart/form-data" method="POST">
                @csrf

                    ...
                    <tbody>
                        @foreach ($menu_packages as $package)
                            <tr>
                                ...
                                <td class="table-head text-white">{{ $restaurant->nama_paket }}</td>
                                ...
                                <td>
                                    ...
                                    @can('paket-menu-edit')
                                    <a class="btn btn-warning p-2 f-12" href="{{ route('paket-menu.edit', $restaurant->id) }}">
                                    ...
                                    <a href="#" class="btn btn-danger p-2 f-12" onclick="modalDelete('Paket Menu', '{{ $restaurant->nama }}', '/paket-menu/' + {{ $restaurant->id }}, '/paket-menu/')">

<div class="modal modal-fullscreen" id="edit-biliard{{ $biliard->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="forms-sample" method="POST" action="{{ route('biliard.update', $biliard->id) }}" novalidate>
                @method('patch')
                @csrf

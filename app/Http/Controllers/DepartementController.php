...
class DepartementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('master-data.departements.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('master-data.departements.create',$data);
    }
    ...
    public function show($id)
    {
        ...
        return view('master-data.departements.show', $data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('master-data.departements.edit',$data);
    }
